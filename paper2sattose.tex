...
\author{
David Arroyo Menendez, Jesus Gonzalez-Barahona \\ Grupo de Sistemas y Comunicaciones (GSyC) \\ Universidad Rey Juan Carlos, Madrid, Spain \\ \{d.arroyome@alumnos, jgb@gsyc\}.urjc.es
}
...
In Section 2, we explain Damegender as solution to the problem,
explaining that we are using Open Datasets extracted from the states
as base of truth. Section 3, presents a feature comparison with other
tools.  Section 4, reproduces accuracies and confusion matrix with a
scientific dataset. The section 5 is about how we are using Machine
Learning in Damegender. The section 6 is about conclusion, limitations
and futher research.
