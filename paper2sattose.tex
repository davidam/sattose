...
\author{
David Arroyo Menendez, Jesus Gonzalez-Barahona, Gregorio Robles \\ Grupo de Sistemas y Comunicaciones (GSyC) \\ Universidad Rey Juan Carlos, Madrid, Spain \\ \{d.arroyome@alumnos, jgb@gsyc, grex@gsyc\}.urjc.es
}
...
\grex{Estaria bien contar con ``the monthly subscription cost (calculated for 100,000 requests/month)'' en la tabla, porque daría más info muy relevante.}
\davidam{Si te da tiempo por mi adelante}
...
Thanks to:
Gregorio Robles by the support and suggestions for publish this article in Sattose
